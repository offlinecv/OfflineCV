...
//  - `deriveCompanyKey` DOES have callers now — `lib/letters/resolve-letter.ts`
//    and `components/features/JobTracker.tsx`, both reaching
//    `./company-key.ts` directly. That leaf is pure and
