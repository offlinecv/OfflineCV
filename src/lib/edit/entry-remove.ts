 ...
 * longer on screen, and goes on showing in "How your resume was read" (#680).
 * So each rendered row is dropped through the existing `removeBullet`, which
 * already knows how to splice one line out of all three line containers (`mutateBulletLine` with
