...
**Real-user PDFs do not belong here**, even though this repo is currently private. Sources for PII-free fixtures:

- [OpenResume sample fixtures](https://github.com/xitanggg/open-resume/tree/main/public/resume-example) — placeholder personas, the upstream this parser was ported from
- [Awesome-CV](https://github.com/posquit0/Awesome-CV/tree/master/examples) — LaTeX template with rendered example PDFs
- [Deedy-Resume](https://github.com/deedy/Deedy-Resume) — LaTeX template with two font variants
- Open a LaTeX/Word/Docs template, fill with synthetic data (`Jane Smith`, etc.), export
- Ask permission from a friend → redact name/email/phone/address before committing

If you discover real PII in a committed fixture, rotate the file via `git filter-branch` or BFG before the public release squash. See [CLAUDE.md](../../../CLAUDE.md) for the public-release plan.
