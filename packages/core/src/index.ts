 ...
 *
 *   - **The two runtime closures are disjoint.** Measured: 29 modules from this
 ...
 * 66 modules, of which 40 are reachable — 29 from this barrel and 11 from
 ...
 * rather than about the file list, and on that graph it holds exactly: 29
